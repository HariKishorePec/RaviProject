...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // remove border & rounding on small screens to avoid visible white edge on mobile
        ...
        // keep rounded corners starting from small screens (sm breakpoint) but remove border to avoid outer white edge
        "sm:rounded-lg",
        className
      )}
      {...props}
